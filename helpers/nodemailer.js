...
const sendEmail = async (toEmail, subject = 'Congratulation You Have Been Enrolled!', htmlContent= `  <div>
        <div class="text-center my-10">
          <h2 class="text-gray-800 text-3xl font-bold mb-3">Selamat Datang di Kursus Vakir Kami!</h2>
